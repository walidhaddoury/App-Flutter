...
class ContestCreate extends StatefulWidget {
  const ContestCreate({super.key});

  @override
  State<ContestCreate> createState() => _ContestCreateState();
}
...
class Contest extends Event {
  ...
  DateTime Date;
  String PictureUrl;
  Contest(this.Name, this.Address, this.RiderList, this.Date,
      this.PictureUrl)
      : super('', [], '', '', '', '', '', '', []);
}
...
class _ContestCreateState extends State<ContestCreate> {
